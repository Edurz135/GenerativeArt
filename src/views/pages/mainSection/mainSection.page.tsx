    ...
    <div className="w-screen h-screen" style={{ backgroundColor: "#F8F0E5" }}>
      <div className="flex flex-col h-screen relative">
        ...
        <div className="z-10 relative ml-32 mt-16" style={{ color: "#0F2C59" }}>
          <span
            className="text-4xl mr-4 tracking-wider"
            style={{ textShadow: "3px 3px #DAC0A3" }}
          >
            just
          </span>
          <span
            className="text-7xl font-bold tracking-wider"
            style={{ textShadow: "5px 5px #DAC0A3" }}
          >
            GENERATIVE
          </span>
        </div>
        ...
        {/* ART */}
        <div
          className="z-10 relative w-screen mt-64 pr-16 flex justify-end"
          style={{ color: "#0F2C59" }}
        >
          <span
            className="text-7xl font-bold tracking-wider inline-block rotate-90"
            style={{ textShadow: "5px -5px #DAC0A3" }}
          >
            ART
          </span>
        ...
        {/* Footer */}
        <div
          className="z-10 absolute bottom-0 ml-32 mb-16 text-xl"
          style={{ color: "#0F2C59", textShadow: "3px 3px #DAC0A3" }}
        >
          Eduardo Ramón.
        </div>
      </div>
